...
# model_state_dict = torch.load(args.model_path, map_location='cuda')
...
# # vae
# ldm = torch.load(args.kl_path, map_location="cuda")
# ldm.to(device)
# ldm.eval()
...
# sd = torch.load(args.bert_path, map_location="cuda")
