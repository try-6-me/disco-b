...
def get_inbetweens(key_frames, integer=False, max_frames=1, interp_spline='Linear'):
...
def split_prompts(prompts, max_frames=10000):
    prompt_series = pd.Series([np.nan for a in range(max_frames)])
    for i, prompt in prompts.items():
        # print("prompt_series",i,prompt)
        prompt_series[i] = prompt#[0]
